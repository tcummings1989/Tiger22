package tcummings1989.ObjSuper;
...
public class IPhone extends CellPhone {
   ...
   public void sendText(CellPhone receiver) {
       ...
       */
      if (receiver.getModel()=="iPhone"){
         System.out.println(this.getOwnerName() +" is sending a blue text to " + "reveiver.getOwnerName()");
      }
      else{
         System.out.println(this.getOwnerName() +" is sending a green text to " + "reveiver.getOwnerName()");
      }
